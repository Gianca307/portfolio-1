...
const Contacto = () => {
  return (
    <main className="flex flex-col gap-15 my-30">
      <a
        className="flex justify-center items-center gap-2"
        href="mailto:gianca307@gmail.com"
      ...
      >
        ...
        <span className="sm:text-lg">gianca307@gmail.com</span>
      </a>

      <a
        className="flex justify-center items-center gap-2"
        href="https://www.linkedin.com/in/giancarlo-portaluppi-b33637228"
        rel="noreferrer noopener"
        target="_blank"
      >
        <svg
        ...
        <span className="sm:text-lg">www.linkedin.com</span>
      </a>
    </main>
  );
};
